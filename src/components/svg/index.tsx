...
export { ReactComponent as AdonisSvg } from '@/assets/skills/adonis.svg'
export { ReactComponent as PlasmoSvg } from '@/assets/skills/plasmo.svg'
export { ReactComponent as CapacitorJsSvg } from '@/assets/skills/capacitorjs.svg'
export { ReactComponent as NegativeCapacitorJsSvg } from '@/assets/skills/negative-capacitorjs.svg'
